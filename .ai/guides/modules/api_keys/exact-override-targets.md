...
| di | `overrides.di["apiKeyPrincipalService"]` | disable-replace | ownedContracts.di-registration:apiKeyPrincipalService | [di.ts:6](../../../../node_modules/@open-mercato/core/src/modules/api_keys/di.ts#L6) |

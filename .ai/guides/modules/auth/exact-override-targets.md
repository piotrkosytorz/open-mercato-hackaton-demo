...
| di | `overrides.di["authPrincipalService"]` | disable-replace | ownedContracts.di-registration:authPrincipalService | [di.ts:43](../../../../node_modules/@open-mercato/core/src/modules/auth/di.ts#L43) |
| di | `overrides.di["authService"]` | disable-replace | ownedContracts.di-registration:authService | [di.ts:41](../../../../node_modules/@open-mercato/core/src/modules/auth/di.ts#L41) |
| di | `overrides.di["rbacService"]` | disable-replace | ownedContracts.di-registration:rbacService | [di.ts:55](../../../../node_modules/@open-mercato/core/src/modules/auth/di.ts#L55) |

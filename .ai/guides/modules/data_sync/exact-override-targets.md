...
| workers | `overrides.workers["data-sync:export"]` | disable-replace | ownedContracts.worker:data-sync:export | [workers/sync-export.ts:25](../../../../node_modules/@open-mercato/core/src/modules/data_sync/workers/sync-export.ts#L25) |
| workers | `overrides.workers["data-sync:import"]` | disable-replace | ownedContracts.worker:data-sync:import | [workers/sync-import.ts:25](../../../../node_modules/@open-mercato/core/src/modules/data_sync/workers/sync-import.ts#L25) |

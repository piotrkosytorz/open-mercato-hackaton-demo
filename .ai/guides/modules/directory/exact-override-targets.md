...
| di | `overrides.di["organizationHierarchyService"]` | disable-replace | ownedContracts.di-registration:organizationHierarchyService | [di.ts:11](../../../../node_modules/@open-mercato/core/src/modules/directory/di.ts#L11) |
| di | `overrides.di["organizationScopeService"]` | disable-replace | ownedContracts.di-registration:organizationScopeService | [di.ts:12](../../../../node_modules/@open-mercato/core/src/modules/directory/di.ts#L12) |

...
|---|---|---|---|---|---|---|
| entity:sales.settings:mutation-guard | mutation-guard | entity:sales.settings @sales | mutation-guard | — | — | [api/settings/document-numbers/route.ts:110](../../../../node_modules/@open-mercato/core/src/modules/sales/api/settings/document-numbers/route.ts#L110) |
...
| widget-spot:data-table:sales.payments:columns:widget-injection-consumer | widget-injection-consumer | widget-spot:data-table:sales.payments:columns @sales | widget, data-table, crud-form | — | hosts:paymentsTable.columns | [extension-points.ts](../../../../node_modules/@open-mercato/core/src/modules/sales/extension-points.ts) |

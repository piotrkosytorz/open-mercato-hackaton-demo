...
| sales.injection.payment-gateway-status-column@data-table:sales.payments:columns | widget-spot:data-table:sales.payments:columns @sales | bound | widget-spot:data-table:sales.payments:columns:widget-injection-consumer | [widgets/injection-table.ts](../../../../node_modules/@open-mercato/core/src/modules/sales/widgets/injection-table.ts) |

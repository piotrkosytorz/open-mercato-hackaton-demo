...
| cli | `overrides.cli["audit-queue-targets"]` | disable-replace | cliCommands:audit-queue-targets | [cli.ts](../../../../node_modules/@open-mercato/scheduler/src/modules/scheduler/cli.ts) |
...
| workers | `overrides.workers["scheduler:test-echo-queue"]` | disable-replace | ownedContracts.worker:scheduler:test-echo-queue | [workers/test-echo-queue.worker.ts:6](../../../../node_modules/@open-mercato/scheduler/src/modules/scheduler/workers/test-echo-queue.worker.ts#L6) |
| workers | `overrides.workers["scheduler:workers:execute-schedule.worker"]` | disable-replace | ownedContracts.worker:scheduler:workers:execute-schedule.worker | [workers/execute-schedule.worker.ts:26](../../../../node_modules/@open-mercato/scheduler/src/modules/scheduler/workers/execute-schedule.worker.ts#L26) |

...
| workflows:workflow_definition_draft | entity | response-enricher, query-enricher, mutation-guard, entity-extension | tenant-and-organization | STABLE | entities:workflows:workflow_definition_draft |
| workflows:workflow_definition_metric_rollup | entity | response-enricher, query-enricher, mutation-guard, entity-extension | tenant-and-organization | STABLE | entities:workflows:workflow_definition_metric_rollup |
...
| workflows.agent.action | event | async-subscriber, sync-subscriber, browser-client | tenant-organization-and-audience | STABLE | events:workflows.agent.action |
...
| workflows.definition.published | event | async-subscriber, sync-subscriber | tenant-organization-and-audience | STABLE | events:workflows.definition.published |
...
| workflows.instance.cancelled | event | async-subscriber, sync-subscriber, browser-client | tenant-organization-and-audience | STABLE | events:workflows.instance.cancelled |
| workflows.instance.completed | event | async-subscriber, sync-subscriber, browser-client | tenant-organization-and-audience | STABLE | events:workflows.instance.completed |
...
| workflows.instance.failed | event | async-subscriber, sync-subscriber, browser-client | tenant-organization-and-audience | STABLE | events:workflows.instance.failed |
| workflows.instance.milestone_reached | event | async-subscriber, sync-subscriber, browser-client | tenant-organization-and-audience | STABLE | events:workflows.instance.milestone_reached |
| workflows.instance.paused | event | async-subscriber, sync-subscriber, browser-client | tenant-organization-and-audience | STABLE | events:workflows.instance.paused |
| workflows.instance.resumed | event | async-subscriber, sync-subscriber, browser-client | tenant-organization-and-audience | STABLE | events:workflows.instance.resumed |
| workflows.instance.started | event | async-subscriber, sync-subscriber, browser-client | tenant-organization-and-audience | STABLE | events:workflows.instance.started |
...
| workflows.task.deadline_breached | event | async-subscriber, sync-subscriber | tenant-organization-and-audience | STABLE | events:workflows.task.deadline_breached |
| workflows.task.portal_assigned | event | async-subscriber, sync-subscriber, browser-portal | tenant-organization-and-audience | STABLE | events:workflows.task.portal_assigned |
| workflows.task.reminder_due | event | async-subscriber, sync-subscriber | tenant-organization-and-audience | STABLE | events:workflows.task.reminder_due |

# open-mercato-hackaton-demo — Standalone App Agent Rules
...
Enabled module facts: `ai_assistant`,`api_docs`,`api_keys`,`attachments`,`audit_logs`,`auth`,`business_rules`,`catalog`,`channel_apns`,`channel_expo`,`channel_fcm`,`channel_gmail`,`channel_imap`,`channel_resend`,`channel_ses`,`checkout`,`communication_channels`,`configs`,`content`,`currencies`,`customer_accounts`,`customers`,`dashboards`,`data_sync`,`devices`,`dictionaries`,`directory`,`documents`,`entities`,`eudr`,`events`,`feature_toggles`,`gateway_stripe`,`inbox_ops`,`integrations`,`messages`,`notifications`,`onboarding`,`payment_gateways`,`perspectives`,`phone_calls`,`planner`,`portal`,`progress`,`push_notifications`,`query_index`,`resources`,`sales`,`scheduler`,`search`,`shipping_carriers`,`staff`,`sync_akeneo`,`sync_excel`,`tillio`,`translations`,`warranty_claims`,`webhooks`,`wms`,`workflows`.
